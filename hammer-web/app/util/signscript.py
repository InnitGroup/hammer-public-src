...
def signUTF8(
    contentToSign : str,
    formatAutomatically : bool = True,
    addNewLine : bool = True,
    useNewKey : bool = False,
    twelveclient: bool = False
) -> str | bytes:
    """
    ...
    with open( web_config.RSA_PRIVATE_KEY_PATH if not useNewKey else web_config.RSA_PRIVATE_KEY_PATH2 , "rb" ) as f:
