...
{RunScript}
   ...
   <soapenv:Body>
    ...
    def FormatGameOpenJSON( self, PlaceId : int, CreatorId : int, JobId : str, ApiKey : str, MaxPlayers : int = 10, GsmInterval : int = 20, PortNumber : int = 53640, CreatorType : str = "User", PlaceVersion : int = 1, MachineAddress : str = "127.0.0.1", UniverseId : int | None = 0, BaseDomain : str = "hammer.rip", GameCode : str | None = None, VipOwnerId : int | None = None ) -> str:
        """
        ...
        return json.dumps({
            ...
            "Settings": {
                ...
                "PlaceFetchUrl": f"https://www.{BaseDomain}/asset/?id={str(PlaceId)}"
            }
        })


    def ParseGetAllJobsResponse( self, ResponseText : str ) -> list[dict]:
        """
